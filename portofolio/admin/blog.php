...
if (isset($_GET['delete'])) {
  ...
  $del = mysqli_query($conn, "DELETE FROM blog WHERE id = $id");
  if ($del) {
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                        <a href="tambah-blog.php?edit=<?php echo $row['id'] ?>" class="btn btn-success btn-sm">Edit</a>
                        <a onclick="return confirm ('Yakin ingin menghapus?')" href="blog.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm">Delete</a>
