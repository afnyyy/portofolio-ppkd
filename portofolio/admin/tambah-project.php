...
if (isset($_POST['simpan'])) {
  ...
  if ($foto['error'] == 0) {
    ...
    $insert = mysqli_query($conn, "INSERT INTO project(nama, kategori, foto) VALUES ('$nama_project', 'kategori', '$fileName')");
    if ($insert) {
...
if (isset($_POST['edit'])) {
  ...
  $qUpdate = mysqli_query($conn, "UPDATE project SET $fillQupdate nama='$nama_project', kategori='$kategori' WHERE id = $id");
  if ($qUpdate){
            ...
            <div class="card-body">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama project" required value="<?php echo isset($_GET['edit']) ? $rowUpdate['nama'] : '' ?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-2">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="kategori" placeholder="Masukkan Kategori" required value="<?php echo isset($_GET['edit']) ? $rowUpdate['kategori'] : '' ?>">
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-2">
