          ...
          <div class="card-body">
            ...
            <div class="table table-responsive">
              <table class="table table-bordered text-center">
                ...
                <tr>
                  <td><?php echo $no++ ?></td>
                  <td><img width="135" src="assets/uploads/<?php echo $row['photo']?>"></td>
                  <td><?php echo $row['nama']?></td>
                  <td><?php echo $row['jabatan']?></td>
                  <td><?php echo $row['deskripsi']?></td>
                  <td>
                    <a href="add_edit_profile.php?idEdt=<?php echo $row['id'] ?>" class="btn btn-success btn-sm">Edit</a>
                    ...
                    <form action="profile.php?idSt=<?php echo $row['id'] ?>" method="post"><input onchange="this.form.submit()" type="radio" name='status' <?php echo isset($row['status']) && $row['status'] == 1 ? 'checked' : '' ?>value="1"></form>
                  </td>
                </tr>
                <?php
                } ?>
