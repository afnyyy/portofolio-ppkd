...
$rows = mysqli_fetch_all($service, MYSQLI_ASSOC);
...
$query = mysqli_query($conn, "SELECT * FROM project ORDER BY id DESC");
$rowsProject = mysqli_fetch_all($query, MYSQLI_ASSOC);

$blog = mysqli_query($conn, "SELECT * FROM blog");
$rowBlog = mysqli_fetch_all($blog, MYSQLI_ASSOC);
	          ...
	          <div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
			            ...
			            <p><a href="#" class="btn btn-primary py-3 px-4">Hire me</a> <a href="#" class="btn btn-white btn-outline-white py-3 px-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nulla, eos?</a></p>
		            </div>
		          </div>
	        	</div>
	        </div>
    		...
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img-about img d-flex align-items-stretch">
    					<div class="overlay"></div>
	    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(assets/uploads/<?php echo $rowAbout['logo'] ?>);">
	    				</div>
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span>Name :</span> <span><?= $rowAbout['nama_lengkap']?></span></li>
		            	<li class="d-flex"><span>Address:</span> <span><?= $rowAbout['alamat']?></span></li>
		            	<li class="d-flex"><span>Website:</span> <span><?= $rowAbout['tanggal_lahir']?></span></li>
		            	<li class="d-flex"><span>Email:</span> <span><?= $rowAbout['email']?></span></li>
		            	<li class="d-flex"><span>Phone: </span> <span><?= $rowAbout['tlpn']?></span></li>
		            </ul>
		          </div>
		        </div>
					...
					foreach ($rows as $row) { ?>
						<div class="col-md-4 text-center d-flex ftco-animate">
							<a href="#" class="services-1">
								<span class="icon">
									<img width="100" src="assets/uploads/<?= $row['foto'] ?>" alt="">
								</span>
								<div class="desc">
    	...
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
    		...
    		<div class="row">
					...
					?>
					<?php foreach ($rowsProject as $index => $project) { ?>
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <div class="text mt-3 float-right d-block">
              	<div class="d-flex align-items-center mb-3 meta">
	                <p class="mb-0">
	                	<span class="mr-2"><?= $row['created_at'] ?></span>
	                	<a href="#" class="mr-2"><?= $row['penulis'] ?></a>
	                	<a href="#" class="meta-chat"><span class="icon-chat"></span><?= $row['id_kategori'] ?></a>
	                </p>
                </div>
                <h3 class="heading"><a href="single.html"><?= $row['judul'] ?></a></h3>
                <p><?= $row['isi'] ?></p>
              </div>
            </div>
          </div>
        ...
        <div class="row no-gutters block-9">
          <div class="col-md-6 order-md-last d-flex">
            <form action="" class="bg-light p-4 p-md-5 contact-form" method="POST">
              ...
              <div class="form-group">
                <input name="subjek" type="text" class="form-control" required placeholder="Subjek">
              </div>
              <div class="form-group">
