    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add Edit Services</h5>
              <form action="" method="post" enctype="multipart/form-data">
                <div class="row mb-3">
                  <div class="col-sm-2">
                    <label for="">Nama Services</label>
                  </div>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nama_service" placeholder="Masukkan Nama Service" required value="<?php echo isset($_GET['Edit']) ? $rowUpdate['nama_service'] : '' ?>">
                  </div>
                </div>
